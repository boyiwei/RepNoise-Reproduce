...
from immunization_llms.datasets import BT_CATEGORIES, DEFAULT_BATCH_SIZE
...
def construct_beavertails_dataset(tokenizer, train_harmful_subset="all", test_harmful_subset="all", batch_size=DEFAULT_BATCH_SIZE, strong_attack=False):
    trainds = None
